...
class ShareBottomSheet {
  ...
  void settingModalBottomSheet(
      context, String doctorUid, String doctorFirstName, String userId) {
                      ...
                      children: <Widget>[
                        ...
                        RaisedButton(
                            ...
                            onPressed: () {
                              ...
                              setData.then((data) => {
                                    data.setString(
                                        "doctor name", doctorFirstName),
                                  });
                              _transaction = UpiTranstionService(
